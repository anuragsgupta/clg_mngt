...
public class FormManager {
    ...
    private FormManager(JFrame frame) {
        ...
        menu = new Menu(new MyDrawerBuilder(FormManager.branch,FormManager.role));
        this.frame.getContentPane().add(panelSlider);
    }
    
    
    public static void setData(String branch ,String role) {
         FormManager.branch = branch;
        FormManager.role = role;
                System.err.println(branch+" form mager w s "+role);

        System.err.println(FormManager.branch+" form mager s"+FormManager.role);
